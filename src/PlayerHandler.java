...
public class PlayerHandler {
	...
	// should be ok)
	public final static int maxPlayers = 200;
	public static Player players[] = new Player[maxPlayers];
	public int playerSlotSearchStart = 1; // where we start searching at when
											// adding a new player
	...
	public void process() {
		...
		// this has to be separated from the outgoing part because we have to
	...
	public boolean savechar(Player plr) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.write("character-friend = 0	1742570869967021");
			characterfile.newLine();
			characterfile.write("character-friend = 1	47096478658021");
			characterfile.newLine();
